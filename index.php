...
<head>
    ...
    <!-- Bootstrap -->
    <link href="http://localhost/gentelacode/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="http://localhost/gentelacode/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="http://localhost/gentelacode/css//nprogress.css" rel="stylesheet">
    <!-- iCheck -->
    <link href="http://localhost/gentelacode/css/green.css" rel="stylesheet">
    <!-- bootstrap-wysiwyg -->
    <link href="http://localhost/gentelacode/css/prettify.min.css" rel="stylesheet">
    <!-- Select2 -->
    <link href="http://localhost/gentelacode/css/select2.min.css" rel="stylesheet">
    <!-- Switchery -->
    <link href="http://localhost/gentelacode/css/switchery.min.css" rel="stylesheet">
    <!-- starrr -->
    <link href="http://localhost/gentelacode/css/starrr.css" rel="stylesheet">
    <!-- bootstrap-daterangepicker -->
    <link href="http://localhost/gentelacode/css/daterangepicker.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="http://localhost/gentelacode/css/custom.min.css" rel="stylesheet">
</head>
...
<!-- jQuery -->
<script src="http://localhost/gentelacode/js/jquery.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Bootstrap -->
<script src="http://localhost/gentelacode/js/bootstrap.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- FastClick -->
<script src="http://localhost/gentelacode/js/fastclick.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- NProgress -->
<script src="http://localhost/gentelacode/js/nprogress.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- bootstrap-progressbar -->
<script src="http://localhost/gentelacode/js/bootstrap-progressbar.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- iCheck -->
<script src="http://localhost/gentelacode/js/icheck.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- bootstrap-daterangepicker -->
<script src="http://localhost/gentelacode/js/moment.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<script src="http://localhost/gentelacode/js/daterangepicker.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- bootstrap-wysiwyg -->
<script src="http://localhost/gentelacode/js/bootstrap-wysiwyg.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<script src="http://localhost/gentelacode/js/jquery.hotkeys.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<script src="http://localhost/gentelacode/js/prettify.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- jQuery Tags Input -->
<script src="http://localhost/gentelacode/js/jquery.tagsinput.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Switchery -->
<script src="http://localhost/gentelacode/js/switchery.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Select2 -->
<script src="http://localhost/gentelacode/js/select2.full.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Parsley -->
<script src="http://localhost/gentelacode/js/parsley.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Autosize -->
<script src="http://localhost/gentelacode/js/autosize.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- jQuery autocomplete -->
<script src="http://localhost/gentelacode/js/jquery.autocomplete.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- starrr -->
<script src="http://localhost/gentelacode/js/starrr.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Custom Theme Scripts -->
<script src="http://localhost/gentelacode/js/custom.min.js" type="8ed73ba0bdc59b0b3793fdd2-text/javascript"></script>
<!-- Google Analytics -->
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/a2bd7673/cloudflare-static/rocket-loader.min.js" data-cf-settings="8ed73ba0bdc59b0b3793fdd2-|49" defer=""></script></body>
</html>
